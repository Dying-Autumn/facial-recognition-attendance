...
-- ============================================
-- 插入用户数据（包含管理员、教师、学生）
-- 注意：UserID是自增的，插入顺序很重要
-- UserID: 1=admin, 2=张老师, 3=李老师, 4-9=学生
-- ============================================
...
-- 插入教师信息
-- 注意：TeacherID是自增的
-- TeacherID: 1=张老师(UserID=2), 2=李老师(UserID=3)
-- ============================================
INSERT INTO `Teacher` (`JobTitle`, `Department`, `UserID`) VALUES
('教授', '计算机学院', 2),    -- TeacherID=1, 对应UserID=2 (张老师)
('副教授', '计算机学院', 3);   -- TeacherID=2, 对应UserID=3 (李老师)

-- ============================================
-- 插入学生信息
-- 注意：studentid是自增的
-- studentid: 1=王小明(userid=4), 2=李华(userid=5), 3=张三(userid=6), 
--            4=李四(userid=7), 5=王五(userid=8), 6=赵六(userid=9)
-- ============================================
INSERT INTO `Student` (`student_number`, `student_name`, `major_class`, `userid`) VALUES
('20210001', '王小明', '计算机2101班', 4),  -- studentid=1
('20210002', '李华', '计算机2101班', 5),    -- studentid=2
('20210003', '张三', '计算机2102班', 6),    -- studentid=3
('20210004', '李四', '计算机2102班', 7),    -- studentid=4
('20210005', '王五', '计算机2103班', 8),    -- studentid=5
('20210006', '赵六', '计算机2103班', 9);    -- studentid=6

-- 插入课程数据
INSERT INTO `Course` (`CourseName`, `CourseCode`, `Credits`, `Semester`, `Description`) VALUES
('高等数学', 'MATH001', 4.0, '2024-2025-1', '高等数学基础课程'),
('大学英语', 'ENG001', 3.0, '2024-2025-1', '大学英语基础课程'),
('计算机基础', 'CS001', 3.5, '2024-2025-1', '计算机科学与技术基础课程'),
('数据结构', 'CS002', 4.0, '2024-2025-1', '数据结构与算法'),
('Java程序设计', 'CS003', 3.5, '2024-2025-1', 'Java编程语言基础');

-- ============================================
-- 插入课程班级数据（关联课程和教师）
-- 注意：ClassID是自增的
-- ClassID: 1=高等数学-01班, 2=大学英语-01班, 3=计算机基础-01班, 
--          4=数据结构-01班, 5=Java程序设计-01班
-- TeacherID: 1=张老师, 2=李老师
-- ============================================
INSERT INTO `CourseClass` (`ClassName`, `CourseID`, `TeacherID`, `Semester`, `ClassTime`, `ClassLocation`) VALUES
-- 张老师（TeacherID=1）的班级
('高等数学-01班', 1, 1, '2024-2025-1', '周一 08:00-09:40', '教学楼A101'),      -- ClassID=1
('计算机基础-01班', 3, 1, '2024-2025-1', '周三 10:00-11:40', '教学楼A201'),    -- ClassID=3
('数据结构-01班', 4, 1, '2024-2025-1', '周五 14:00-15:40', '教学楼A301'),    -- ClassID=4
-- 李老师（TeacherID=2）的班级
('大学英语-01班', 2, 2, '2024-2025-1', '周二 08:00-09:40', '教学楼B101'),      -- ClassID=2
('Java程序设计-01班', 5, 2, '2024-2025-1', '周四 10:00-11:40', '教学楼B201'); -- ClassID=5

-- ============================================
-- 插入学生课程班级关联数据（将学生分配到班级）
-- 注意：StudentID对应Student表的studentid（不是userid）
-- StudentID: 1=王小明, 2=李华, 3=张三, 4=李四, 5=王五, 6=赵六
-- ClassID: 1=高等数学-01班, 2=大学英语-01班, 3=计算机基础-01班, 
--          4=数据结构-01班, 5=Java程序设计-01班
-- ============================================
INSERT INTO `StudentCourseClass` (`StudentID`, `ClassID`, `Status`) VALUES
-- 王小明（StudentID=1）选课
(1, 1, 1), -- 王小明 -> 高等数学-01班 (ClassID=1)
(1, 3, 1), -- 王小明 -> 计算机基础-01班 (ClassID=3)
(1, 4, 1), -- 王小明 -> 数据结构-01班 (ClassID=4)
-- 李华（StudentID=2）选课
(2, 1, 1), -- 李华 -> 高等数学-01班 (ClassID=1)
(2, 2, 1), -- 李华 -> 大学英语-01班 (ClassID=2)
(2, 3, 1), -- 李华 -> 计算机基础-01班 (ClassID=3)
-- 张三（StudentID=3）选课
(3, 1, 1), -- 张三 -> 高等数学-01班 (ClassID=1)
(3, 2, 1), -- 张三 -> 大学英语-01班 (ClassID=2)
(3, 5, 1), -- 张三 -> Java程序设计-01班 (ClassID=5)
-- 李四（StudentID=4）选课
(4, 2, 1), -- 李四 -> 大学英语-01班 (ClassID=2)
(4, 3, 1), -- 李四 -> 计算机基础-01班 (ClassID=3)
(4, 4, 1), -- 李四 -> 数据结构-01班 (ClassID=4)
-- 王五（StudentID=5）选课
(5, 1, 1), -- 王五 -> 高等数学-01班 (ClassID=1)
(5, 4, 1), -- 王五 -> 数据结构-01班 (ClassID=4)
(5, 5, 1), -- 王五 -> Java程序设计-01班 (ClassID=5)
-- 赵六（StudentID=6）选课
(6, 2, 1), -- 赵六 -> 大学英语-01班 (ClassID=2)
(6, 3, 1), -- 赵六 -> 计算机基础-01班 (ClassID=3)
(6, 5, 1); -- 赵六 -> Java程序设计-01班 (ClassID=5)
