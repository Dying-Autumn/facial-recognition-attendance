...
-- 张老师（TeacherID=1）的班级
('高等数学-01班', 1, 1, '2024-2025-1', '周一 08:00-09:40', '教学楼A101'),
('计算机基础-01班', 3, 1, '2024-2025-1', '周三 10:00-11:40', '教学楼A201'),
('数据结构-01班', 4, 1, '2024-2025-1', '周五 14:00-15:40', '教学楼A301'),
-- 李老师（TeacherID=2）的班级
('大学英语-01班', 2, 2, '2024-2025-1', '周二 08:00-09:40', '教学楼B101'),
('Java程序设计-01班', 5, 2, '2024-2025-1', '周四 10:00-11:40', '教学楼B201');

-- 插入学生课程班级关联数据（将学生分配到班级）
INSERT INTO `StudentCourseClass` (`StudentID`, `ClassID`, `Status`) VALUES
-- 王小明（StudentID=1）和李华（StudentID=2）选课
(1, 1, 1), -- 王小明 -> 高等数学-01班
(1, 3, 1), -- 王小明 -> 计算机基础-01班
(1, 4, 1), -- 王小明 -> 数据结构-01班
(2, 1, 1), -- 李华 -> 高等数学-01班
(2, 2, 1), -- 李华 -> 大学英语-01班
(2, 3, 1), -- 李华 -> 计算机基础-01班
-- 张三（StudentID=3）和李四（StudentID=4）选课
(3, 1, 1), -- 张三 -> 高等数学-01班
(3, 2, 1), -- 张三 -> 大学英语-01班
(3, 5, 1), -- 张三 -> Java程序设计-01班
(4, 2, 1), -- 李四 -> 大学英语-01班
(4, 3, 1), -- 李四 -> 计算机基础-01班
(4, 4, 1), -- 李四 -> 数据结构-01班
-- 王五（StudentID=5）和赵六（StudentID=6）选课
(5, 1, 1), -- 王五 -> 高等数学-01班
(5, 4, 1), -- 王五 -> 数据结构-01班
(5, 5, 1), -- 王五 -> Java程序设计-01班
(6, 2, 1), -- 赵六 -> 大学英语-01班
(6, 3, 1), -- 赵六 -> 计算机基础-01班
(6, 5, 1); -- 赵六 -> Java程序设计-01班
